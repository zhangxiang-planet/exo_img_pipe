...
def make_target_list_FRB(target_name, postprocess_dir, exo_dir):
    ...
    # Define the maximum angular distance between points
    max_angular_distance = 2.0  # in degrees
...
def make_target_list_SL(target_name, postprocess_dir, exo_dir):
