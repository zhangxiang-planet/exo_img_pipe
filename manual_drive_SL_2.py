...
from templates.Make_Target_List_template import make_target_list_SL
...
postprocess_dir = "/data/xzhang/SL/"
...
cal = 'CYG_A'
cali_check = True
cal_dir = '20240704_014500_20240704_020000_CYG_A_TRACKING/L1'
exo_dir = '20240704_000200_20240704_014500_TYC_3524-548-1_TRACKING/L1'
...
def subtract_Ateam(exo_dir: str):
    ...
    cmd_ddf = (
        f'DDF.py {pipe_dir}/templates/template_DI.parset --Data-MS {postprocess_dir}{exo_dir}/GSB.MS --Data-ColName DATA --Output-Name {postprocess_dir}{exo_dir}/Image_DI_Bis '
        f'--Cache-Reset 1 --Cache-Dir {postprocess_dir}{exo_dir}/. --Deconv-Mode SSD2 --Mask-Auto 1 --Mask-SigTh 7 --Deconv-MaxMajorIter 1 --Deconv-RMSFactor 3 --Deconv-PeakFactor 0.1 --Facets-NFacet 1 --Facets-DiamMax 5 '
...
def dynspec(exo_dir: str):
    ...
    make_target_list_SL(target_name, postprocess_dir, exo_dir)
